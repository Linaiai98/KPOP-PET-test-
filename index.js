...
jQuery(async () => {
    ...
    (function() {
        ...
        script.src = `${extensionFolderPath}/firebase-loader.js`;
        script.type = 'module'; // 使用 module 类型以支持 import/export
        document.head.appendChild(script);
        console.log(`[${extensionName}] Firebase loader script added.`);
    })();
